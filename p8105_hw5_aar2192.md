...
This graph is organized in ascending order from cities with a low proportion of unsolved homicides to a high proportion. From what we can see, Chicago has the highest proportion while Ricmond has the lowest among the 50 cities.
